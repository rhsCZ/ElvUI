...
General.moneyHide = ACH:Toggle(E.NewSign..L["Money Hide"], L["Hides Blizzards price lines."], 12, nil, nil, nil, nil, nil, function() return not E.db.tooltip.moneyLines end, not E.Retail)
General.fadeOut = ACH:Toggle(L["Fade Out"], L["Fade out the tooltip when it disappears, instant otherwise. Cursor anchored tooltips are unaffected."], 13)
